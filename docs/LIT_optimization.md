...
**Reads:** `docs/DOMAIN_optimization.md` §6 (2026-09-03; every `§2.x` reference below is to that A1 copy, not to the hub's `docs/DOMAIN_optimization.md`), with context from `docs/APPROACHES.md` §A1,
