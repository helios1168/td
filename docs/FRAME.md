...
**Date:** 2026-09-02 · **Framework:** 0.1-dev · **Reads:** `docs/CHANNEL.md`, `docs/MODEL.md`,
`docs/DATA.md`, `docs/REVIEW_GROMOV.md`, `docs/RESEARCH_FINDINGS.md` (§0, §9), `CLAUDE.md`,
`td/solvers/base.py` · **Supersedes:** `CHANNEL.md` §6 (the 72-rep / $6.2B / k≈6 /
