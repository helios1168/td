...
**Run:** 2026-09-01 (overnight), per `docs/foundations/archive/RESEARCH_GUIDE.md` · **Method:** seven parallel
...
7. **Certificate endgame**: MIPLIB-style three-way status (certified/bounded/open) in
   `docs/foundations/archive/RESULTS.md` (gleixner2021), performance profiles (beiranvand2017), VIPR as the
