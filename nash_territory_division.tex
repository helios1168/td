...
(Section~\ref{sec:contig}) comes for free there. The problem solved in this note is a
finite sampling of that continuum, so the agreement is a consistency check rather than a
corollary.
...
\noindent $a$ receives $22$ zips, $48.9\%$ of opportunity. Kalai--Smorodinsky and equal
...
than fixed: at $\rho=10^{-5}$ the boundary cuts a fifth of all adjacency edges for a
$0.16\%$ gain in product over the $\rho=2\times10^{-3}$ solution. Report the product and
...
3 & 22 & $0.0471$ & $0.537$ & adjudicate\\
4 & 19 & $0.0352$ & $0.540$ & adjudicate\\
5 & 28 & $0.0302$ & $0.570$ & coin-flip\\
\bottomrule\end{tabular}\end{center}
