...
| 2026-09-10 | v3 CONUS (real, 6,459 zips) | J | geo, no caps | default six | 161 | pending | direct, 6 | 600 s | pending | pending | pending | `battery/results/full_problem/v3_joint_geo` |
| 2026-09-10 | v3 CONUS | S | geo, no caps | N, then WH and WH⁺, then FI, FI⁺, WHFI | 23 in the N stage | pending | direct, 4 | 600 s | pending | pending | pending | `battery/results/full_problem/v3_seq_geo` |
